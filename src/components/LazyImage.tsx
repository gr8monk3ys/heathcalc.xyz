...
import { reserveSpaceFor } from '@/utils/performance';
...
/**
 * LazyImage component with blur-up effect
 * Improves Core Web Vitals by optimizing Largest Contentful Paint (LCP)
 */
