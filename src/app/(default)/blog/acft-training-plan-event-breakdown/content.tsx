      ...
      <div className="prose prose-lg max-w-none">
        <div className="neumorph p-6 rounded-lg mb-8">
          ...
          <ul className="space-y-2">
            ...
            <li>
              Your two-mile run time will improve more from interval training and threshold runs
              than from just running more miles at a comfortable pace.
            </li>
            <li>
        ...
        <p>
          I have trained for the ACFT the wrong way and the right way. The wrong way was doing
          random workouts and hoping that general fitness would carry me. It did not. I scored 430
          on my first attempt. Not bad, but nowhere near where I wanted to be.
        </p>

        <p>
          The right way was building a structured program that addressed each event with specific
          training methods, progressed intensity over 8 weeks, and peaked for test day. That
          approach took me from 430 to 548 in a single training cycle. The program I am sharing here
          is based on what worked for me and for the soldiers I have coached since.
        </p>

        <h2 className="text-2xl font-bold mt-8 mb-4">The 8-Week Program Structure</h2>

        <p>
          Eight weeks divides cleanly into three phases. Weeks 1-3 build your base. Weeks 4-6
          increase intensity and specificity. Weeks 7-8 are about peaking and tapering. Each phase
          has a distinct purpose, and skipping ahead is counterproductive.
        </p>
        ...
        <p>
          ...
          wonder why they stall at 200 lbs on test day. The deadlift is a strength event. You need
          to train heavy to get stronger. Period.
        </p>
        ...
        <div className="neumorph p-6 rounded-lg my-4">
          ...
          <ul className="list-disc list-inside space-y-1">
            ...
            <li>
              Day 2: Romanian deadlift (conventional barbell), 3 sets of 8. Builds hamstring
              strength and teaches hip hinge mechanics.
            </li>
            <li>
          ...
          <ul className="list-disc list-inside space-y-1">
            <li>
              Day 1: Hex bar deadlift, work up to a heavy set of 3 reps. Then 3 back-off sets of 3
              at 85% of that weight. This is where you build actual strength.
            </li>
            <li>
              Day 2: Deficit deadlifts or paused deadlifts, 4 sets of 3. These build strength off
              the floor where most soldiers are weakest.
            </li>
            <li>
          ...
          <ul className="list-disc list-inside space-y-1">
            ...
            <li>
              Week 8: Light deadlifts only. 2-3 sets of 3 at 60% of your tested max. Keep the
              pattern fresh without creating fatigue.
            </li>
          </ul>
        </div>
        ...
        <div className="neumorph p-6 rounded-lg my-6 bg-yellow-50 dark:bg-yellow-900/10">
          ...
          <p>
            Training with sets of 10 reps. This builds endurance, not maximal strength. The ACFT
            tests your 3-rep max. You need to train with sets of 3-5 reps at heavy weights. If your
            training sets never go above 60% of your max, you will not get stronger.
          </p>
        </div>
        ...
        <div className="neumorph p-6 rounded-lg my-4">
          ...
          <ul className="list-disc list-inside space-y-1">
            ...
            <li>
              Practice the actual throw 2x per week with a 10-lb med ball. Do not worry about
              distance yet. Focus on the movement pattern: squat, extend, release.
            </li>
          </ul>
        ...
        <p>
          This is where I disagree with most ACFT training advice. The standard recommendation is
          "do more push-ups." That is lazy coaching. If you are stuck at 25 hand-release push-ups
          and you just do more sets of 25, you will stay stuck at 25. You need to build the muscles
        ...
        <div className="neumorph p-6 rounded-lg my-4">
          ...
          <ul className="list-disc list-inside space-y-1">
            ...
            <li>
              Hand-release push-ups: 3 sets to 75% of your max. If your max is 30, do 3 sets of
              22-23. Rest 90 seconds between sets.
            </li>
          ...
          <ul className="list-disc list-inside space-y-1">
            <li>
              Increase push-up volume: 4 sets to 80% of max, with 60-second rest periods (shorter
              rest forces adaptation).
            </li>
            <li>
            ...
            <li>
              Continue bench press but shift to higher reps: 3 sets of 15 with moderate weight.
            </li>
            <li>
          ...
          <ul className="list-disc list-inside space-y-1">
            ...
            <li>
              Week 8: 2 light sets of push-ups. Do not burn yourself out before the real test.
            </li>
          </ul>
        </div>
        ...
        <div className="neumorph p-6 rounded-lg my-4">
          ...
          <ul className="list-disc list-inside space-y-1">
            <li>
              ...
              meters. If no sled is available, use a heavy tire or even a training buddy on a towel
              on a smooth floor.
            </li>
            <li>
            ...
            <li>
              Lateral shuffle drills: 4 x 50 meters. Practice staying low with a wide base. Do not
              let your feet cross. Speed increases as technique improves.
            </li>
            <li>
              Sprint intervals: 6 x 50-meter sprints with 60 seconds rest. Build your acceleration
              and top speed.
            </li>
          </ul>
          ...
          <ul className="list-disc list-inside space-y-1">
            ...
            <li>
              ...
              sprint) and alternate them for 5 rounds with 90 seconds rest. This builds
            ...
            <li>
              Add shuttle runs (down-and-back 25-meter sprints) to your conditioning work. 8 sets
              with 45 seconds rest builds the specific energy system the SDC demands.
            </li>
          </ul>
        ...
        <div className="neumorph p-6 rounded-lg my-4">
          ...
          <ul className="list-disc list-inside space-y-1">
            <li>
              Plank holds: 3 sets at 70% of your max hold time. If you can hold for 2 minutes, do 3
              x 1:24. Rest 60 seconds between sets.
            </li>
            <li>
              Dead bugs: 3 sets of 10 per side. Builds anti-extension core strength, which is
              exactly what the plank demands.
            </li>
            <li>
          ...
          <ul className="list-disc list-inside space-y-1">
            ...
            <li>
              Add weighted planks: put a 10-25 lb plate on your back. Hold for 60% of your
              bodyweight plank time. When you remove the weight on test day, the plank will feel
              noticeably easier.
            </li>
            <li>
              Plank shoulder taps: 3 sets of 12 per side. Removes one point of contact and forces
              the remaining three to work harder. Builds dynamic stability.
            </li>
            <li>
        ...
        <p>
          ...
          the deadlift by just doing max-effort deadlifts every session. It works up to a point,
          then you plateau hard. The soldiers I have seen make the biggest improvements in their run
          times are the ones who stopped running the same 2-mile loop at the same pace every other
          day.
        </p>
        ...
        <div className="neumorph p-6 rounded-lg my-4">
          ...
          <ul className="list-disc list-inside space-y-1">
            ...
            <li>
              Tempo run: Find a pace you can sustain for 20 minutes but not 40. Run at that pace
              after a 10-minute warmup. This should feel like a 7 out of 10 effort.
            </li>
          </ul>
          ...
          <ul className="list-disc list-inside space-y-1">
            ...
            <li>
              Week 5: 5 x 600 meters at goal pace, 2 minutes rest. Longer intervals build your
            ...
            <li>
              Keep one easy run and one tempo run each week alongside the intervals. Total: 3 runs
              per week.
            </li>
          </ul>
          ...
          <ul className="list-disc list-inside space-y-1">
            <li>
              ...
              day predictor. Note: on the actual ACFT, you will be fatigued from 5 previous events,
              so add 30-60 seconds to this time for a realistic prediction.
            </li>
        ...
        <p>
          Here is how I structure a typical training week during Phase 2 (Weeks 4-6). This assumes
          you are training 5 days per week with 2 rest days. Adjust based on your unit schedule.
        </p>
          ...
          <table className="min-w-full border-collapse border border-gray-300 dark:border-gray-600 text-sm">
            ...
            <tbody>
              <tr>
                ...
                <td className="border border-gray-300 dark:border-gray-600 px-4 py-2">
                  Bench press 3x10, overhead press 3x8, push-up timed sets 3x60sec, dips 3x10,
              ...
              <tr>
                ...
                <td className="border border-gray-300 dark:border-gray-600 px-4 py-2">
                  20-min tempo run, weighted plank 3x45sec, dead bugs 3x10/side, ab wheel rollouts
                  3x8
                </td>
              </tr>
              <tr className="bg-gray-50 dark:bg-gray-800/50">
        ...
        <p>
          Seven hours minimum. I know that sounds impossible during a field rotation. But during
          your 8-week ACFT training block, prioritize sleep. Your muscles do not get stronger during
          the workout. They get stronger during recovery. Cut the sleep short and you cut the gains
          short. Research consistently shows that sleep deprivation impairs strength output,
          reaction time, and endurance. All things the ACFT tests.
        </p>
        ...
        <div className="neumorph p-6 rounded-lg my-4">
          ...
          <p>
            ...
            training. Undereating is the number one recovery killer I see in soldiers. The DFAC
            meals may not be gourmet, but eat enough of them. If you are losing weight
            unintentionally during your training block, you are not eating enough.
          </p>

          <p className="font-semibold mt-4 mb-2">Protein:</p>
          <p>
            Aim for 0.8-1.0 grams per pound of bodyweight daily. For a 180-lb soldier, that is
            144-180 grams of protein per day. This supports muscle recovery and growth. If you are
            not hitting this number through food alone, a protein supplement can fill the gap.
            Nothing fancy. Whey protein or a plant-based alternative works fine.
          </p>
          ...
          <p>
            ...
            Fort Moore and Fort Bliss), you need significantly more than the standard
            recommendation.
          </p>
        ...
        <p>
          ...
          recovery. A 20-minute walk, light stretching, foam rolling, or a casual bike ride. The
          goal is to move without creating additional fatigue. Think 3 out of 10 effort, maximum.
        </p>
        ...
        <p>
          ...
          grinding through heavy deadlifts and hard runs 48 hours before the ACFT, then wondering
          why their legs feel like concrete on test morning.
        </p>
        ...
        <div className="neumorph p-6 rounded-lg my-6">
          ...
          <p className="mb-3">
            Last hard session. Full ACFT simulation or a challenging combined workout. After this,
            you are done with intense training.
          </p>
          ...
          <p className="mb-3">
            Light 20-minute run at easy pace. A few sets of push-ups. Light deadlift work (3x3 at
            50% max). Nothing challenging.
          </p>
        ...
        <p>
          ...
          . This serves two purposes. First, it shows you which events are responding to training
          and which are lagging. Second, it keeps you motivated. Watching your estimated score climb
          from 380 to 420 to 470 over six weeks is powerful motivation to keep training.
        </p>

        <div className="neumorph p-6 rounded-lg my-6">
          <p>
            The calculator breaks down your score by event and shows your overall category. If you
            are targeting Gold (540+), you need to know exactly where your weak points are. Maybe
            your deadlift is already at 90 points but your plank is sitting at 65. That tells you
            where to focus your training energy.
          </p>
          <p className="mt-4">
            <Link
