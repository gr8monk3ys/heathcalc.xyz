  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <div className="prose prose-lg max-w-none">
        <div className="neumorph p-6 rounded-lg mb-8">
          ...
          <ul className="space-y-2">
            <li>
              ...
              Mounjaro contains a different molecule (tirzepatide) that hits two receptors instead
              of one.
            </li>
            <li>
            ...
            <li>
              Ozempic is FDA-approved only for type 2 diabetes. Using it for weight loss is
              off-label, which matters for insurance coverage.
            </li>
            <li>
        ...
        <p>
          This comparison is based on clinical trial data, FDA labeling, and the current (as of
          early 2026) pricing and coverage landscape. I will be specific about what the data shows
          and where the data has gaps.
        </p>
        ...
        <p>
          ...
          1.0 mg dose is also available). Wegovy is approved for chronic weight management. Its
          target maintenance dose is 2.4 mg per week, which is 20% higher than Ozempic&apos;s
          maximum.
        </p>

        <p>
          In practice, many doctors prescribe Ozempic off-label for weight loss. Sometimes this is
          because it is easier to get covered by insurance (diabetes medications generally have
          better coverage than weight loss medications). Sometimes it is because Wegovy has been in
          and out of shortage since its launch.
        </p>

        <p>
          The practical consequence: someone taking Ozempic at 1.0 mg for weight loss is getting
          less than half the weight-loss dose studied in the STEP trials. They will still lose some
          weight, but likely less than someone on Wegovy 2.4 mg. If you are using Ozempic for weight
          loss and have plateaued, the dose difference may be part of the reason.
        </p>
        ...
        <p>
          Whether that dual mechanism explains the superior weight loss results or whether
          tirzepatide just happens to be a more potent molecule is still debated. The practical
          result, however, is clear: tirzepatide produces more weight loss in clinical trials.
        </p>
        ...
        <h2 className="text-2xl font-bold mt-10 mb-4">
          Head-to-Head Efficacy: What the Data Shows
        </h2>

        <p>
          We do not have a direct randomized trial comparing Wegovy 2.4 mg against Zepbound 15 mg in
          a weight loss population. That is the comparison everyone wants, and it does not exist
          yet.
        </p>
        ...
        <p>
          ...
          participants lost over 20% of their body weight. With semaglutide, about a third did. For
          a 250-pound person, that is the difference between losing 37 pounds and losing 52 pounds.
        </p>
        ...
        <p>
          ...
          announced in late 2024 confirmed tirzepatide&apos;s superiority, with a roughly 5
          percentage point greater weight loss.
        </p>
        ...
        <p>
          ...
          differ, and this matters because the ramp-up period determines how long it takes to reach
          a therapeutic dose and how much time you spend dealing with dose-escalation side effects.
        </p>
        ...
        <p>
          A few practical notes. The Wegovy and Mounjaro/Zepbound titration schedules are designed
          to be followed as written. Each step gives your body time to adapt before increasing the
          dose. Rushing this process leads to worse side effects without meaningfully faster weight
          loss.
        </p>
        ...
        <p>
          ...
          with fewer side effects. Discuss with your prescriber whether the maximum dose is right
          for you.
        </p>
            ...
            <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
              ...
              <tr>
                <td className="px-4 py-3 font-semibold">
                  With commercial insurance (typical copay)
                </td>
        ...
        <p>
          ...
          company (bypassing pharmacies and insurance entirely). This changed the pricing
          conversation significantly for tirzepatide.
        </p>
        ...
        <p>
          Medicare explicitly does not cover weight loss medications. This affects a large
          population of older adults with obesity who would benefit from these drugs. Legislation
          (the Treat and Reduce Obesity Act) has been introduced to change this, but as of early
          2026, it has not passed.
        </p>

        <h2 className="text-2xl font-bold mt-10 mb-4">Insurance Coverage: The Obstacle Course</h2>

        <p>
          Getting insurance to cover a GLP-1 medication for weight loss is often a multi-step
          process. Here is what it typically involves.
        </p>
        ...
        <p>
          ...
          versa. Some plans cover neither for weight loss but cover Ozempic or Mounjaro for
          diabetes.
        </p>

        <p>
          Step 3: Step therapy. Some insurers require you to try and fail a less expensive
          medication first (like phentermine or naltrexone-bupropion) before they will approve a
          GLP-1.
        </p>

        <p>
          Step 4: Ongoing documentation. Many insurers require periodic re-authorization, sometimes
          every 6 or 12 months, with evidence that the medication is working (usually defined as a
          5% weight loss threshold).
        </p>

        <p>
          The reality is that a significant number of people who would benefit from these
          medications cannot access them because of cost and coverage barriers. If your insurance
          denies coverage, ask your doctor about the appeals process. First-level denials are often
        ...
        <p>
          Under the Federal Food, Drug, and Cosmetic Act, compounding pharmacies can produce copies
          of FDA-approved drugs when those drugs are listed on the FDA Drug Shortage List.
          Semaglutide was on the shortage list from March 2022 through early 2024. During that
          period, compounding pharmacies legally produced and sold semaglutide at a fraction of the
          brand-name price.
        </p>

        <p>
          Here is where it gets complicated. As Novo Nordisk ramped up production and the FDA
          shortage designation was resolved, the legal basis for compounding semaglutide began to
          erode. Novo Nordisk filed lawsuits and the FDA issued guidance restricting compounding of
          semaglutide. Some compounding pharmacies have continued to operate in legal gray areas,
          arguing various exemptions.
        </p>
        ...
        <p>
          ...
          levels of oversight. Testing by independent labs has found that some compounded
          semaglutide products contain less active ingredient than labeled, and some have contained
          impurities. Others have tested accurately. You are relying on the specific pharmacy&apos;s
          quality control.
        </p>

        <p>
          <strong>Legal status is uncertain.</strong> What is legal today may not be tomorrow.
          Several compounding pharmacies have received cease-and-desist letters. If you are on a
          compounded version and the pharmacy is forced to stop producing it, you need a backup
          plan.
        </p>

        <p>
          <strong>Dosing may differ.</strong> Compounded versions may come in vials that require you
          to draw up your own injection, rather than pre-filled pens. This introduces the
          possibility of dosing errors. Make sure you are comfortable with the injection process and
        ...
        <p>
          ...
          despite producing more weight loss. The vomiting difference is particularly notable (25%
          vs 12%). If GI tolerance is a primary concern for you, tirzepatide may be better
          tolerated.
        </p>

        <p>
          Discontinuation rates due to adverse events are similar between the two drugs (roughly
          6-7%), suggesting that while semaglutide causes more GI symptoms, the severity is
          ...
          <div className="space-y-4 text-gray-700 dark:text-gray-300">
            <div>
              ...
              <p>
                ...
                with lower GI side effect rates. If insurance covers it or you can manage the cost,
                it is the strongest option based on current data.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                Both Mounjaro and Ozempic are FDA-approved for diabetes and produce significant
                weight loss. Mounjaro produces more weight loss and better A1c reduction in
                head-to-head data (SURPASS-2). Insurance coverage for the diabetes indication is
                typically better than for weight loss.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                ...
                trial showing a 20% reduction in MACE events. Tirzepatide cardiovascular outcomes
                data (SURPASS-CVOT) is expected but not yet published.
              </p>
            </div>
        ...
        <p>
          Rybelsus is an oral formulation of semaglutide, currently approved only for type 2
          diabetes at doses up to 14 mg daily. It is taken as a pill rather than an injection, which
          some people prefer.
        </p>

        <p>
          However, oral semaglutide at the 14 mg dose produces significantly less weight loss than
          the injectable 2.4 mg dose. Oral bioavailability of semaglutide is only about 1%, meaning
          most of the pill is destroyed in the GI tract before it gets absorbed. You need a much
          larger dose orally to achieve the same blood levels.
        </p>

        <p>
          Novo Nordisk is developing a higher-dose oral semaglutide (25 mg and 50 mg) specifically
          for weight loss. Phase 3 trials (the OASIS program) showed the 50 mg oral dose produced
          about 15.1% weight loss at 68 weeks, which is comparable to injectable Wegovy 2.4 mg. An
          FDA application has been submitted, with potential approval in 2026.
        </p>

        <p>
          If you hate needles, this might eventually be your best option. But it is not available
          for weight loss yet.
        </p>
        ...
        <p>
          <strong>CagriSema</strong> (Novo Nordisk) combines semaglutide with cagrilintide (an
          amylin analog). The REDEFINE program is testing this combination, with early data
          suggesting weight loss potentially exceeding individual components.
        </p>
        ...
        <div className="neumorph p-6 rounded-lg mt-8">
          ...
          <ul className="space-y-1 text-sm text-gray-600 dark:text-gray-400">
            ...
            <li>
              Frias JP, et al. &quot;Tirzepatide versus Semaglutide Once Weekly in Patients with
              Type 2 Diabetes.&quot; NEJM, 2021. (SURPASS-2)
            </li>
            <li>
            ...
            <li>
              Knop FK, et al. &quot;Oral Semaglutide 50 mg Taken Once Daily in Adults with
              Overweight or Obesity.&quot; Lancet, 2023. (OASIS 1)
            </li>
