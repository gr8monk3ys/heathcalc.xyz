      ...
      <div className="prose prose-lg max-w-none">
        <div className="neumorph p-6 rounded-lg mb-8">
          ...
          <ul className="space-y-2">
            <li>
              You need 60 points minimum on every event and 360 total to pass. Fail one event and
              you fail the entire test, no matter how well you do on the other five.
            </li>
            <li>
              Gold standard (540+) requires averaging 90 points per event. That is a serious level
              of fitness across all six domains.
            </li>
            <li>
              The two-mile run has the highest failure rate of any event, followed by the plank.
              These two events end careers.
            </li>
            <li>
        ...
        <p>
          When the ACFT replaced the APFT, scoring went from simple to complex overnight. The old
          test had two events with push-ups and sit-ups and a two-mile run. Three events. One
          scoring table. Simple. The ACFT has six events, gender-normed scoring tables, age group
          adjustments, and a tiered category system. I have spent hours studying the scoring tables,
          and I still reference them regularly.
        </p>

        <p>
          This guide breaks down everything you need to know about ACFT scoring: the numbers you
          need to hit, what the tiers mean, how age and gender affect your standards, and where the
          danger zones are. I am going to give you the data straight with no padding. Bookmark this
          page. You will come back to it.
        </p>

        <h2 className="text-2xl font-bold mt-8 mb-4">The Basics: How ACFT Scoring Works</h2>

        <p>
          Each of the six events is scored on a 0-100 point scale. Your total score is the sum of
          all six, giving you a maximum possible score of 600. The minimum passing score is 60
          points per event, with a total minimum of 360.
        </p>
        ...
        <p>
          ...
          hypothetical. I have personally seen this happen to strong soldiers who neglected one
          event.
        </p>
        ...
        <p>
          Below are the scoring breakpoints for each event. The ACFT uses gender-specific scoring
          for five of six events (the Plank is scored the same for everyone). Scores between
          breakpoints are interpolated, meaning if your performance falls between two listed values,
        ...
        <p>
          ...
          recognizes ten age brackets: 17-21, 22-26, 27-31, 32-36, 37-41, 42-46, 47-51, 52-56,
          57-61, and 62+.
        </p>
        ...
        <div className="neumorph p-6 rounded-lg my-6">
          ...
          <ul className="list-disc list-inside space-y-2">
            <li>
              <strong>17-21 and 22-26:</strong> These are the hardest brackets. The Army expects
              peak physical performance in this range. If you are in this group, your standards are
              the most demanding.
            </li>
            <li>
            ...
            <li>
              ...
              challenging, but they account for the reality that a 50-year-old soldier is not
              expected to match a 22-year-old in raw performance.
            </li>
          </ul>
        </div>
        ...
        <p>
          ...
          explicitly a negative mark, but in a competitive promotion environment, scoring in the
          Black tier while your peers are Silver and Gold puts you at a disadvantage. Senior leaders
          notice. If you are sitting at 380, your goal should be to get above 420 as quickly as
          possible.
        </p>
        ...
        <div className="neumorph p-6 rounded-lg my-6">
          ...
          <ul className="list-disc list-inside space-y-2">
            ...
            <li>
              ...
              official standard, but high ACFT scores still help with promotion boards and
              competitive assignments.
            </li>
            <li>
              <strong>Combat Service Support (68-series, 88M, 92 series, etc.):</strong> Same
              official standards. The ACFT does not differentiate MOS in its scoring tables. But the
        ...
        <p>
          The biggest shift is that the ACFT tests physical domains the APFT completely ignored.
          Under the APFT, you could be a fantastic runner and push-up machine while having zero
          lower body strength and still max the test. The ACFT does not allow that. You have to be
          strong (deadlift), powerful (power throw), endurant in both muscular and aerobic senses
          (push-ups, plank, two-mile run), and functionally fast under load (SDC).
        </p>
        ...
        <div className="neumorph p-6 rounded-lg my-6">
          ...
          <p className="mb-3">
            When the test used the Leg Tuck, the failure rate for women was over 70%. After
            switching to the Plank as the primary option, that dropped to about 22%. For men, the
            plank failure rate is relatively low (under 5%). But soldiers who neglect core training
            still fail this event regularly. A 2:20 plank is not automatic if you have not trained
            for it.
          </p>
          ...
          <p>
            These events have relatively low failure rates. The deadlift minimum (200 lbs for men,
            130 lbs for women) is achievable for most soldiers who have spent any time in a gym. The
            power throw and SDC favor raw athleticism, which most young soldiers possess.
          </p>
        </div>
        ...
        <p>
          ...
          specifics of how ACFT points convert to promotion points have evolved as the Army
          integrates the test into the broader evaluation framework, but the principle is
          straightforward: higher ACFT scores earn more promotion points.
        </p>
        ...
        <div className="neumorph p-6 rounded-lg my-6">
          ...
          <ul className="list-disc list-inside space-y-2">
            ...
            <li>
              ...
              appear on your evaluation. A Gold-rated NCO signals to the board that this soldier
              takes physical fitness seriously. It is not the only factor, but it matters.
            </li>
            <li>
        ...
        <p>
          ...
          performance can have different promotion outcomes based on their ACFT scores. It is not
          the deciding factor, but it is a tiebreaker. And in the Army promotion system, tiebreakers
          matter.
        </p>
        ...
        <div className="neumorph p-6 rounded-lg my-6">
          <p className="mb-4">
            Enter your deadlift weight, power throw distance, push-up count, SDC time, plank time,
            and run time. The calculator does the rest, including gender-specific scoring and
            category assignment.
          </p>
          <p>
            <Link
        ...
        <p>
          ...
          career weight, and the scoring tables are specific enough that knowing your numbers
          matters.
        </p>

        <p>
          Study the tables. Know what you need to hit for your target category. Identify which
          events give you the most room for improvement. Then train accordingly. The soldiers who
          treat the ACFT as a known problem with a clear solution perform far better than the ones
          who show up hoping for the best.
        </p>

        <p>
          And one more thing: test yourself regularly using the same standards you will be graded
          on. Practice the exact events with the exact equipment. Know your numbers cold before you
          step onto that test field. No surprises.
        </p>
        ...
        <div className="mt-12 border-t pt-8">
          ...
          <ul className="space-y-3 text-sm text-gray-600">
            ...
            <li>
              ...
              Test, While Males Pass Easily.&quot; May 2021.
            </li>
            <li>
