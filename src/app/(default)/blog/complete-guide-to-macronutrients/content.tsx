    ...
    <article className="max-w-4xl mx-auto px-4 py-12">
      ...
      <div className="prose prose-lg dark:prose-invert max-w-none">
        ...
        <p className="text-xl text-gray-700 dark:text-gray-300 mb-6">
          Nutrition discourse has a problem. Every macronutrient has been cast as the villain at
          some point. Fat was evil in the 1980s and 1990s. Carbs took over as the enemy in the 2000s
          and 2010s. Protein has mostly escaped demonization, though you will occasionally hear
          someone claim it destroys your kidneys (it does not, in healthy people).
        </p>

        <p>
          The reality is simpler and less dramatic. Each macronutrient has a role. None of them is
          inherently harmful. The amounts and ratios that work best for you depend on your goals,
          your activity level, and your personal preferences. Let me walk through what the research
          actually says.
        </p>
        ...
        <p>
          ...
          published extensively on this topic. His group&apos;s work consistently lands in the 1.6
          to 2.2 g/kg range for active individuals. For someone weighing 80 kg (176 pounds), that is
          128 to 176 grams of protein per day.
        </p>
        ...
        <p>
          ...
          training. You had to consume protein within 30 to 60 minutes of your workout, or the
          session was wasted.
        </p>

        <p>
          This turned out to be mostly wrong. A 2013 meta-analysis by Schoenfeld, Aragon, and
          Krieger in the Journal of the International Society of Sports Nutrition examined the
          effect of protein timing on muscle growth and strength. They found that the apparent
          benefits of immediate post-workout protein disappeared once total daily protein intake was
          controlled for.
        </p>

        <p>
          In other words: people who ate more protein around their workouts tended to eat more
          protein overall. And it was the total daily amount, not the timing, that drove the
          results.
        </p>
        ...
        <p>
          But the differences are small compared to simply hitting your total daily target. If you
          eat 1.6 g/kg spread across your normal meals, you are getting 90% of the benefit
          regardless of when exactly those meals fall relative to your workout.
        </p>
        ...
        <p>
          ...
          therefore carbs make you fat. It sounds logical. It has been promoted by best-selling
          books for decades. And it is wrong.
        </p>
        ...
        <p>
          ...
          controlled). They spent two weeks on a high-carb diet and two weeks on a ketogenic diet
          with the same total calories.
        </p>

        <p>
          If the insulin hypothesis were correct, the low-carb diet should have produced
          significantly more fat loss due to lower insulin levels. It did not. Fat loss was
          virtually identical between the two conditions. The body lost the same amount of fat
          regardless of insulin levels, as long as total calories were the same.
        </p>
        ...
        <p>
          ...
          (around 3 to 5 g/kg body weight) is generally sufficient. If you are an endurance athlete
          or training at high volumes, you need more (5 to 8 g/kg or higher). If you are sedentary
          and your primary goal is fat loss, you can go lower without performance consequences,
        ...
        <p>
          ...
          Whittaker and Harris in the Journal of Steroid Biochemistry and Molecular Biology found
          that men who consumed less than 20% of calories from fat had significantly lower
          testosterone levels compared to those consuming 30 to 40%.
        </p>

        <p>
          For most people, 25 to 35% of total calories from fat is a good target. That is enough to
          support hormonal function and vitamin absorption while leaving room for adequate protein
          and carbs. Use our{' '}
        ...
        <p>
          ...
          Heart Association recommends limiting saturated fat to less than 10% of calories. But a
          2020 Cochrane review found that while reducing saturated fat lowered blood cholesterol,
          the evidence linking saturated fat reduction directly to cardiovascular events was less
        ...
        <p>
          <strong>Monounsaturated and polyunsaturated fats</strong> (olive oil, nuts, avocados,
          fatty fish) have the strongest evidence for health benefits. Omega-3 fatty acids in
          particular have strong evidence for reducing inflammation and cardiovascular risk.
        </p>
        ...
        <p>
          ...
          roughly half the minimum recommended intake. It is a massive gap between what people eat
          and what the evidence suggests they should eat.
        </p>
        ...
        <p>
          This is one of the most common questions in nutrition, and the answer depends on your
          goal.
        </p>

        <p>
          <strong>For weight loss:</strong> Total calories matter more. As the metabolic ward
          studies and diet comparison research show, the specific ratio of carbs to fat does not
          meaningfully affect fat loss when calories are matched. What matters is the deficit.
          However, within that calorie budget, higher protein is better for preserving muscle and
          controlling appetite.
        </p>

        <p>
          <strong>For muscle gain:</strong> Protein takes priority. You need a calorie surplus (or
          at least maintenance) plus sufficient protein to support muscle protein synthesis. The
          ratio of carbs to fat filling the rest of your calories is less important, though carbs
          support training performance.
        </p>

        <p>
          <strong>For athletic performance:</strong> Carb intake becomes much more important.
          Glycogen fuels high-intensity work. Athletes who chronically undereat carbs often see
          performance declines, impaired recovery, and increased injury risk. For serious athletes,
          macro ratios matter more than they do for the general population.
        </p>

        <p>
          <strong>For general health:</strong> The quality of your macros matters more than the
          exact ratios. Whole food sources of protein, carbs, and fat will serve you better than
          processed alternatives regardless of the percentages.
        </p>
        ...
        <p>
          ...
          evidence for adequate protein is consistent across goals. The carb-to-fat ratio is where
        ...
        <p>
          ...
          to estimate your maintenance calories. Adjust up or down based on your goal (deficit for
          fat loss, surplus for muscle gain, maintenance for recomposition).
        </p>

        <p>
          <strong>Step 2: Set protein first.</strong> Multiply your body weight in kilograms by 1.6
          to 2.2. This is your daily protein target in grams. Each gram of protein has 4 calories.
        </p>

        <p>
          <strong>Step 3: Set fat at a minimum.</strong> Aim for at least 0.7 to 1.0 g per kg of
          body weight, or about 25 to 30% of total calories. Each gram of fat has 9 calories.
        </p>
        ...
        <p>
          The most productive thing you can do is stop thinking about macros in terms of good and
          evil and start thinking about them in terms of amounts that serve your goals. Hit your
          protein target. Eat enough fat for hormonal health. Adjust carbs based on activity and
          preference. Get your fiber up.
        </p>

        <p>
          That is not as exciting as a manifesto declaring war on a specific nutrient. But it is
          what the research consistently supports, and it is an approach you can maintain for the
          rest of your life.
        </p>
        ...
        <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
          <li>
            ...
            effect of protein supplementation on resistance training-induced gains in muscle mass
            and strength.&quot; British Journal of Sports Medicine, 2018.
          </li>
          <li>
            Bauer J, et al. &quot;Evidence-based recommendations for optimal dietary protein intake
            in older people: a position paper from the PROT-AGE study group.&quot; Journal of the
          ...
          <li>
            Hall KD, et al. &quot;Energy expenditure and body composition changes after an
            isocaloric ketogenic diet in overweight and obese men.&quot; American Journal of
          ...
          <li>
            ...
            disease.&quot; Cochrane Database of Systematic Reviews, 2020.
          </li>
        </ul>
      </div>
    </article>
