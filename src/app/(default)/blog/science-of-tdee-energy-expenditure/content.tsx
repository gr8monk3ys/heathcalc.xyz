      ...
      <div className="prose prose-lg dark:prose-invert max-w-none">
        <div className="neumorph-card rounded-xl p-6 mb-8">
          ...
          <ul className="space-y-2 text-gray-700 dark:text-gray-300">
            ...
            <li>
              Your total daily energy expenditure has four components, and the one most people
              ignore (NEAT) is often the largest variable
            </li>
            <li>
              Activity multipliers used in online calculators were created from averages that
              probably don&apos;t describe you personally
            </li>
            <li>
        ...
        <p className="text-xl text-gray-700 dark:text-gray-300 mb-6">
          ...
          , gives you an estimate. Not a measurement. An educated guess based on population data
          that may or may not describe your body, your genetics, or the way you actually move
          through a Tuesday.
        </p>

        <p>
          That&apos;s not a flaw. It&apos;s the honest starting point for understanding how your
          body spends energy. The problem is that most people treat calculator output as gospel,
          then get confused when their weight doesn&apos;t respond the way the math predicted.
        </p>

        <p>
          So let&apos;s dig into how TDEE actually works, where the formulas come from, why they
          miss, and how you can get closer to your real number.
        </p>
        ...
        <p>
          Total Daily Energy Expenditure is the total number of calories your body burns in a
          24-hour period. Every single thing your body does costs energy: pumping blood, digesting
          food, fidgeting, thinking, walking to the fridge, running a 5K. TDEE is the sum of all of
          it.
        </p>

        <p>
          If you eat more calories than your TDEE, the surplus gets stored (mostly as fat, some as
          glycogen). If you eat fewer, your body pulls from stored energy. This is the energy
          balance equation, and while plenty of people try to argue it away, it holds up under every
        ...
        <p>
          Your TDEE breaks down into four distinct components. Understanding what each one
          contributes (and which ones you can actually influence) is the key to making sense of your
          metabolism.
        </p>
        ...
        <p>
          ...
          your body would still need fuel to maintain core temperature, run your organs, sustain
          your brain, and keep cells dividing. That baseline cost is your BMR.
        </p>
        ...
        <p>
          ...
          , but understand that the formulas behind it were derived from averaging measurements
          across study populations. Your individual BMR could be 200 calories higher or lower than
          what any equation predicts.
        </p>
        ...
        <p>
          ...
          body spends 20 to 30 of those calories just digesting it. Carbohydrates run about 5-10%.
          Fat is the cheapest to process at 0-3%.
        </p>

        <p>
          This is one reason high-protein diets seem to give people a metabolic edge. They literally
          cost more energy to process. It&apos;s not a huge effect on its own, but over the course
          of a day, the difference between a high-protein diet and a high-fat diet can be 100 to 200
        ...
        <p>
          Levine&apos;s team found that obese individuals sat, on average, 2.5 hours more per day
          than lean individuals. The lean subjects weren&apos;t exercising more. They were simply
          more active throughout the day in ways they weren&apos;t even conscious of. They stood
          more. They walked more. They moved more while doing routine tasks.
        </p>

        <p>
          This finding has been replicated multiple times since then, including a 2018 study in the
          European Journal of Clinical Nutrition that tracked NEAT in 150 adults using
          accelerometers. The conclusion was the same: NEAT is the single largest variable component
          of TDEE for most people, and it&apos;s almost completely invisible.
        </p>
        ...
        <div className="neumorph-card rounded-xl p-6 my-8 bg-yellow-50 dark:bg-yellow-900/20">
          ...
          <p className="text-gray-700 dark:text-gray-300">
            A 60-minute gym session might burn 300 to 500 calories. NEAT across 15 waking hours
            could burn 300 to 2,000 calories. When your NEAT drops (because you&apos;re dieting,
            stressed, or exhausted), it can wipe out your entire calorie deficit without you
            noticing.
          </p>
        </div>
        ...
        <p>
          ...
          Mifflin-St Jeor equation. Published in 1990, it replaced the older Harris-Benedict
          equation (1919) as the recommended formula by the Academy of Nutrition and Dietetics.
        </p>
        ...
        <p>
          But &quot;within 10%&quot; is not &quot;accurate.&quot; For someone with a true BMR of
          1,600 calories, a 10% error means the calculator could say anywhere from 1,440 to 1,760.
        ...
        <p>
          ...
          non-obese adults in clinical settings. It doesn&apos;t account for lean mass (muscle)
          versus fat mass directly. It doesn&apos;t adjust for thyroid function, genetics, gut
          microbiome composition, or the dozens of other variables that influence how your specific
          body burns fuel. The Katch-McArdle formula tries to address the lean mass issue by using
          body fat percentage, but that requires knowing your body fat percentage, which introduces
        ...
        <p>
          Even if the BMR estimate were perfect, TDEE calculators have a second layer of
          imprecision: the activity multiplier.
        </p>
        ...
        <p>
          ...
          studied energy expenditure in various populations. They were useful for broad public
          health estimates. They were never intended to describe one specific person.
        </p>
        ...
        <p>
          I think activity multipliers are the weakest link in every online TDEE calculator. They
          take a reasonably decent BMR estimate and inject a massive source of error. If your BMR is
          off by 10% and your activity multiplier is also off by 10%, those errors compound.
        </p>
        ...
        <p>
          ...
          Nutrition. They found that after a 10% loss of body weight, resting metabolic rate
          decreased by more than what the loss of body mass alone would predict. The body became
          more efficient, burning fewer calories per pound of tissue than it did before the weight
          loss.
        </p>

        <p>
          This phenomenon, called adaptive thermogenesis (or metabolic adaptation), means your body
          is actively resisting further weight loss. It&apos;s not broken. It&apos;s doing exactly
          what evolution designed it to do: protect against starvation.
        </p>

        <p>
          The magnitude of adaptation varies, but studies suggest it can reduce TDEE by 5-15% beyond
          what weight loss alone would predict. For someone with a calculated TDEE of 2,200
          calories, that&apos;s a potential 110 to 330 calorie reduction you can&apos;t see on any
          calculator.
        </p>
        ...
        <p>
          The famous &quot;Biggest Loser&quot; study by Fothergill et al. (2016, published in
          Obesity) tracked contestants six years after the show. Their metabolic rates had not
          recovered. Some had BMRs 500+ calories lower than expected for their body size. This was
          an extreme case involving massive rapid weight loss, and most people won&apos;t experience
          adaptation to that degree. But it illustrates how persistent the effect can be.
        </p>
        ...
        <div className="neumorph-card rounded-xl p-6 my-8 bg-red-50 dark:bg-red-900/20">
          ...
          <div className="space-y-2 text-gray-700 dark:text-gray-300">
            ...
            <p>
              ...
              shrunk to 200 or less because NEAT dropped, BMR decreased, and you&apos;re
              unconsciously moving less.
            </p>
          </div>
        </div>
        ...
        <p>
          ...
          point. And for a starting point, it&apos;s better than guessing randomly. But if you want
          to find your actual TDEE, here is what I recommend.
        </p>
        ...
        <p>
          ...
          you&apos;ll have a working TDEE number that&apos;s far more accurate than any formula
          could give you.
        </p>
        ...
        <p>
          After years of reading forums and working through nutrition questions, I see the same
        ...
        <p>
          <strong>Overestimating activity level.</strong> Most people who work desk jobs and
          exercise 3 to 4 times per week are closer to &quot;lightly active&quot; than
          &quot;moderately active,&quot; especially if they drive to the gym, sit during their
          commute, and spend evenings on the couch. Be honest with yourself.
        </p>
        ...
        <p>
          ...
          activity multipliers are imprecise, and metabolic adaptation means your TDEE will change
          as your body and behavior change.
        </p>
        ...
        <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
          ...
          <li>
            ...
            resting metabolic rate in healthy nonobese and obese adults.&quot; Journal of the
          ...
          <li>
            Fothergill E, et al. &quot;Persistent metabolic adaptation 6 years after &apos;The
            Biggest Loser&apos; competition.&quot; Obesity, 2016.
          </li>
          <li>
            Westerterp KR. &quot;Exercise, energy balance and body composition.&quot; European
