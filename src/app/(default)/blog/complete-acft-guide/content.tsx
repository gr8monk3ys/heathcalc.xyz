      ...
      <div className="prose prose-lg max-w-none">
        <div className="neumorph p-6 rounded-lg mb-8">
          ...
          <ul className="space-y-2">
            ...
            <li>
              The two-mile run and the leg tuck/plank are statistically the events soldiers fail
              most often.
            </li>
            <li>
              Proper form on each event matters more than raw strength. Small technique fixes can
              add 10-20 points.
            </li>
            <li>
              Use our{' '}
        ...
        <p>
          I remember my first ACFT. I walked onto the field cocky because I had been crushing the
          old APFT for years. Two hours later I was on my hands and knees after the two-mile run,
        ...
        <p>
          Since then, I have coached dozens of soldiers through ACFT preparation, from fresh
          privates barely scraping 360 to NCOs chasing 600. This guide covers everything you need to
          know about the test: what each event involves, how scoring works, where soldiers lose
          points they should not be losing, and how to approach test day strategically.
        </p>
        ...
        <div className="neumorph p-6 rounded-lg my-4">
          ...
          <p>
            Lower body and grip strength. You perform three continuous repetitions of a hex bar
            (trap bar) deadlift at the heaviest weight you can manage.
          </p>
          ...
          <ul className="list-disc list-inside mt-2 space-y-1">
            ...
            <li>
              Keep your back flat. The graders are watching for excessive rounding. A rounded back
              on any rep can get that rep no-counted.
            </li>
        ...
        <div className="neumorph p-6 rounded-lg my-4">
          <p className="font-semibold mb-2">What it tests:</p>
          <p>
            Explosive power from the lower body through the upper body. You throw a 10-pound
            medicine ball backward over your head for maximum distance.
          </p>
          ...
          <ul className="list-disc list-inside mt-2 space-y-1">
            ...
            <li>
              Hold the medicine ball at hip level. Dip into a squat, then explode upward and
              backward, releasing the ball overhead.
            </li>
          ...
          <ul className="list-disc list-inside mt-2 space-y-1">
            <li>
              This is a legs-first movement. The power comes from your hips and quads, not your
              arms. Think of it as a backwards jump.
            </li>
            <li>
        ...
        <div className="neumorph p-6 rounded-lg my-4">
          ...
          <ul className="list-disc list-inside mt-2 space-y-1">
            ...
            <li>
              Lower your body to the ground until your chest touches. Your entire body should
              contact the ground.
            </li>
            <li>
            ...
            <li>
              Place your hands back down and push up to the starting position. That is one rep.
            </li>
            <li>
          ...
          <ul className="list-disc list-inside mt-2 space-y-1">
            <li>
              Keep your body rigid. Sagging hips or piking up will get reps no-counted. The grader
              is watching from the side.
            </li>
            <li>Full arm extension at the top. Your elbows must lock out completely.</li>
            <li>
              The hand release must be clear. Do not just wiggle your fingers. Lift your palms off
              the ground visibly. Some soldiers extend their arms to the side in a "T" position for
              clarity.
            </li>
            <li>
              Pace yourself. Going all-out in the first 30 seconds and burning out is the most
              common mistake I see. Aim for a sustainable rhythm.
            </li>
          </ul>
        </div>
        ...
        <div className="neumorph p-6 rounded-lg my-4">
          <p className="font-semibold mb-2">What it tests:</p>
          <p>
            Anaerobic endurance, agility, and functional strength. This is five 50-meter shuttles
            back to back, each with a different task. It is the most physically demanding single
            event on the test.
          </p>
          ...
          <ul className="list-disc list-inside mt-2 space-y-1">
            <li>
              Transitions kill time. Practice picking up the sled handles and the kettlebells
              quickly. Every second of fumbling adds up.
            </li>
            <li>
              On the sled drag, stay low and drive with your legs. Do not try to pull with your
              arms. Lean forward, dig in, and push the ground behind you.
            </li>
            <li>
        ...
        <div className="neumorph p-6 rounded-lg my-4">
          ...
          <p>
            ...
            possible. The Plank replaced the original Leg Tuck event, which had extremely high
            failure rates (over 70% for female soldiers).
          </p>
          ...
          <ul className="list-disc list-inside mt-2 space-y-1">
            ...
            <li>
              Focus your eyes on a point on the ground about a foot in front of your hands. This
              keeps your neck neutral.
            </li>
            <li>
              When it gets hard (and it will), mentally break the time into 30-second chunks. "Just
              30 more seconds" is more manageable than "I still have a minute left."
            </li>
          </ul>
        </div>
        ...
        <p>
          ...
          test. I have seen this happen. A sergeant who maxed the deadlift, crushed the push-ups,
          and ran a 14-minute two-mile run. Failed because his plank gave out at 2:05. Fifty-seven
          points. Two minutes and twenty seconds was the target. He missed it by fifteen seconds.
        </p>
        ...
        <p>
          ACFT scoring is gender- and age-normed. This means that the raw performance required to
          earn a specific number of points varies depending on whether you are male or female and
          which age bracket you fall into. A 25-year-old male needs to deadlift 200 lbs for 60
          points, while a 25-year-old female needs 130 lbs for the same score.
        </p>
        ...
        <p>
          ...
          event has separate male and female tables. This is important to keep in mind when
          comparing scores across a unit.
        </p>
        ...
        <div className="neumorph p-6 rounded-lg my-6">
          ...
          <p>
            Soldiers rush through reps and fail to fully extend at the hip. The grader needs to see
            a clear lockout. Hips forward, shoulders back, knees straight. If any of those are
            missing, the rep does not count. I have watched soldiers lift 300 lbs and get credit for
            zero reps because they never fully stood up.
          </p>
        </div>
        ...
        <div className="neumorph p-6 rounded-lg my-6">
          ...
          <p>
            The hand release must be obvious. Barely lifting your pinky finger is not going to cut
            it. Graders want to see daylight between your palms and the ground. Some soldiers find
            it helpful to extend their arms out to the sides in a "T" position for maximum clarity.
          </p>
        </div>
        ...
        <div className="neumorph p-6 rounded-lg my-6">
          ...
          <p>
            ...
            have seen soldiers lose 10-15 seconds just in transition time. Practice the full event
            end to end and focus specifically on your transitions.
          </p>
        </div>
        ...
        <div className="neumorph p-6 rounded-lg my-6">
          ...
          <p>
            After five events, you are running on fumes. The adrenaline of starting the run masks
            how tired you actually are. Soldiers go out 20-30 seconds per lap faster than their goal
            pace and completely fall apart by the fourth lap. Negative splits (running the second
            mile faster than the first) almost never happen on the ACFT. The goal is to limit how
            much you slow down.
          </p>
        </div>
        ...
        <p>
          Training is only half the battle. How you approach test day determines whether your
          training translates to your score.
        </p>
        ...
        <div className="neumorph p-6 rounded-lg my-6">
          ...
          <ul className="list-disc list-inside space-y-1">
            <li>
              Eat a normal dinner. Nothing exotic. Not the time to try a new restaurant or
              experiment with pre-workout nutrition.
            </li>
            <li>
              Sleep 7-8 hours if possible. You will not make up for months of poor sleep in one
              night, but do not sabotage yourself either.
            </li>
          ...
          <ul className="list-disc list-inside space-y-1">
            <li>
              Eat 2-3 hours before the test starts. Something you have eaten before training
              sessions. Toast with peanut butter, a banana, oatmeal. Nothing heavy.
            </li>
            <li>Hydrate, but do not overdo it. Sipping water, not chugging it.</li>
            <li>
              Arrive early. Get your lane assignment. Walk through the event stations. Visualize
              your plan for each event.
            </li>
          </ul>
          ...
          <ul className="list-disc list-inside space-y-1">
            ...
            <li>
              Between events, stay loose. Walk around. Do not sit down and stiffen up. Light
              movement keeps blood flowing and maintains readiness.
            </li>
            <li>
        ...
        <p>
          ...
          the old APFT. You cannot just be a good runner or a strong lifter. You have to be both,
          plus everything in between.
        </p>

        <p>
          The good news is that with focused training, most soldiers can pass the ACFT comfortably
          within 8-12 weeks. The bad news is that "focused" means actually addressing your
          weaknesses instead of doing more of what you are already good at. If your deadlift is
          strong but your run is weak, you need to run more, not deadlift more. That sounds obvious,
          but I watch soldiers ignore it constantly.
        </p>

        <p>
          Train smart, practice the actual events, know the standards, and do not leave points on
          the table through poor technique. The ACFT rewards preparation over raw talent.
        </p>
