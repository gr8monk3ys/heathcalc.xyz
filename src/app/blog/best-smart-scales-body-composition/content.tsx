  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <div className="prose prose-lg max-w-none">
        ...
        <h2 className="text-2xl font-bold mt-8 mb-4">1. Withings Body Smart - Best Overall</h2>
        ...
        <h2 className="text-2xl font-bold mt-8 mb-4">2. RENPHO Smart Scale - Best Budget Option</h2>
        ...
        <div className="neumorph p-6 rounded-lg my-8 bg-gray-50">
          <p className="text-sm text-gray-600">
            ...
            additional cost to you and helps support our free health calculators. We only recommend
