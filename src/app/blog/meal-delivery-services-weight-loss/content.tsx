  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <div className="prose prose-lg max-w-none">
        ...
        <h2 className="text-2xl font-bold mt-8 mb-4">1. Factor - Best Overall for Weight Loss</h2>
        ...
        <h2 className="text-2xl font-bold mt-8 mb-4">2. HelloFresh - Best for Home Cooking</h2>
        ...
        <h2 className="text-2xl font-bold mt-8 mb-4">3. Trifecta - Best for Athletes & Macros</h2>
        ...
        <h2 className="text-2xl font-bold mt-8 mb-4">4. MealPro - Best Budget Option</h2>
