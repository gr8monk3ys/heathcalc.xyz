  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <div className="prose prose-lg max-w-none">
        ...
        <h2 className="text-2xl font-bold mt-8 mb-4">1. MyFitnessPal Premium - Best Overall</h2>
        ...
        <h2 className="text-2xl font-bold mt-8 mb-4">2. Cronometer - Best for Accuracy</h2>
        ...
        <h2 className="text-2xl font-bold mt-8 mb-4">3. MacroFactor - Best Adaptive Tracking</h2>
        ...
        <h2 className="text-2xl font-bold mt-8 mb-4">4. Lose It! - Best Free Option</h2>
